...
public interface FlatChain extends Chain
{
     ...
     * @see Builder#onChainComplete(FlatChain.ChainCompleteFunction)
     * 
    ...
    public static class Builder
    {
         ...
         * also be notified of changes via the {@link ElementAddedFunction}, 
         * {@link ElementChangedFunction} or {@link ElementRemovedFunction} 
         ...
         * @return this Builder so that you can chain other Builder methods calls.
         */
        public Builder onElementAdded(ElementAddedFunction function)
        {
            this.elementAddedFunction = function;
            return this;
        }
         ...
         * @return this Builder so that you can chain other Builder methods calls.
         */
        public Builder onElementChanged(ElementChangedFunction function)
        {
            this.elementChangedFunction = function;
            return this;
        }
         ...
         * @return this Builder so that you can chain other Builder methods calls.
         */
        public Builder onElementRemoved(ElementRemovedFunction function)
        {
            this.elementRemovedFunction = function;
            return this;
        }
         ...
         * @return this Builder so that you can chain other Builder methods calls.
         */
        public Builder onChainComplete(ChainCompleteFunction function)
        {
            this.chainCompleteFunction = function;
            return this;
        }
         ...
         * @return this Builder so that you can chain other Builder methods calls.
         */
        public Builder onChainError(ChainErrorFunction function)
        {
            this.chainErrorFunction = function;
            return this;
        }
    }
}
